            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={{ position: 'absolute', bottom: 30, left: 20, right: 20, borderTopWidth: 1, borderTopColor: '#ccc', paddingTop: 5 }}>
                    <Text style={{ fontSize: 6, textAlign: 'center', color: '#666', fontFamily: 'Helvetica' }}>
                        Generado por: {userWhoGenerated || (createdBy ? `${createdBy.firstName} ${createdBy.paternalSurname}` : 'Sistema')} | Fecha: {new Date().toLocaleDateString('es-ES')} {new Date().toLocaleTimeString('es-ES')} | IP: {clientIp || 'No disponible'} | El documento se genero desde el sistema de informacion Escuela Técnica de la U.A.P.
                    </Text>
                </View>
