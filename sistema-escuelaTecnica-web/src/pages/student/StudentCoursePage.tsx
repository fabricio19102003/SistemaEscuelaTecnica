...
const StudentCoursePage = () => {
    ...
    }, [enrollmentId, fetchMyGrades, fetchMyAttendance]);
        ...
        return (
            <div className="p-6 md:p-10 max-w-7xl mx-auto">
                ...
                <button
                    ...
                    className="mt-4 px-6 py-2 bg-[#004694] text-white rounded-lg hover:bg-[#003366]"
                >
                    Volver al Portal
                </button>
            </div>
    ...
    return (
        <div className="p-6 md:p-10 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div>
                <button
                    onClick={() => navigate('/student/portal')}
                    className="flex items-center gap-2 text-[#004694] hover:text-[#003366] mb-4 font-semibold transition-colors"
                >
                    <ArrowLeft size={20} />
                    Volver al Portal
                </button>
                    ...
                    <div className="flex items-start justify-between">
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-3 mt-4">
                                ...
                                <div>
                                    <p className="text-xs text-blue-200 font-medium">Profesor</p>
                        ...
                        <div className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-xl">
                            <p className="text-xs text-blue-200 font-medium">Estado</p>
            ...
            <div className="bg-white rounded-2xl shadow-md p-2 flex gap-2">
                <button
                    ...
                    className={`flex-1 py-3 px-6 rounded-xl font-bold transition-all flex items-center justify-center gap-2 ${
                        activeTab === 'grades'
                            ? 'bg-gradient-to-r from-[#004694] to-[#0066CC] text-white shadow-lg'
            ...
            {activeTab === 'grades' && (
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-md overflow-hidden">
                        <div className="bg-gradient-to-r from-[#004694] to-[#0066CC] text-white p-6">
                                                ...
                                                <div>
                                                    ...
                                                    {attendance.arrivalTime && (
                                                        <p className="text-sm text-gray-500 flex items-center gap-1 mt-1">
                                                            <Clock size={14} />
                                                            Hora de llegada: {new Date(attendance.arrivalTime).toLocaleTimeString('es-ES', {
                                                                hour: '2-digit',
                                                                minute: '2-digit'
                                                            })}
                                                        </p>
