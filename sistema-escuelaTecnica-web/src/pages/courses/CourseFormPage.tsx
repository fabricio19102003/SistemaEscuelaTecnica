...
const CourseFormPage = () => {
    ...
    const { register, control, handleSubmit, formState: { errors }, reset } = useForm<CourseSimpleForm>({
                ...
                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700/50 space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-none"
